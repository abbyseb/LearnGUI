function [result,pixcoord] = cnrmarker(inputfl,roi,bgcorners,refcoord)
%% [result,pixcoord] = cnrmarker(inputfl,roi,bgcorners,refcoord)
% ------------------------------------------
% FILE   : cnrmarker.m
...
%                   rectangle used to calculate the CNR, in the format of
