...
#include "rtkgetelektaangles_ggo.h"
...
{
  GGO(rtkgetelektaangles, args_info);
  ...
  std::vector<double> angles = reader->GetGeometry()->GetGantryAngles();
  
  // Write
  std::ofstream txtfile;
  txtfile.open(args_info.output_arg);
