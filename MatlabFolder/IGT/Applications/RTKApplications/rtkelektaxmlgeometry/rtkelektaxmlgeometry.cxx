...
#include "rtkelektaxmlgeometry_ggo.h"
#include "rtkMacro.h"
...
{
  GGO(rtkelektaxmlgeometry, args_info);

  // Create geometry reader
  rtk::ElektaXMLGeometryReader::Pointer reader;
  reader = rtk::ElektaXMLGeometryReader::New();
  reader->SetXMLFileName(args_info.xmlfile_arg);
