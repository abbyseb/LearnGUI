...
int main(int argc, char * argv[])
{
  ...
  if(args_info.sortfile_given)
	rtk::SetProjectionsReaderFromGgo<projectionsReaderType, args_info_rtkadmmtotalvariation>(projectionsReader, args_info, binReader->GetOutput() );
  else
	rtk::SetProjectionsReaderFromGgo<projectionsReaderType, args_info_rtkadmmtotalvariation>(projectionsReader, args_info);
  ...
  if (args_info.phases_given)
    ...
    phaseGating->SetInputGeometry( geometryPointer );
    phaseGating->Update();
    }
  ...
  if (args_info.phases_given)
    ...
    admmFilter->SetGeometry( geometryPointer );
