...
public:
  ...
  /** Get/Set UseConstantAngularGap */
  bool GetUseConstantAngularGap(){ return m_UseConstantAngularGap; }
  void SetUseConstantAngularGap( bool _arg ){ m_UseConstantAngularGap = _arg; }

protected:
  FDKWeightProjectionFilter()  { m_UseConstantAngularGap = false; }
  ...
  // Andy: for situations where constant angular weighting is desired
  bool m_UseConstantAngularGap;
