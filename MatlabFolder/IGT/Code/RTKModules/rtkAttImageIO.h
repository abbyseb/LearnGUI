...
#ifndef __rtkAttImageIO_h
#define __rtkAttImageIO_h
 ...
 * \ingroup IOFilters
 */
class AttImageIO : public itk::ImageIOBase
{
public:
/** Standard class typedefs. */
  typedef AttImageIO              Self;
  ...
  AttImageIO() : Superclass() {}

  /** Method for creation through the object factory. */
  itkNewMacro(Self);

  /** Run-time type information (and related methods). */
  itkTypeMacro(AttImageIO, ImageIOBase);
  ...
  Att_header GetHeader() { return m_Header; }

  double GetAngle() { return m_Header.dCTProjectionAngle; }
  double GetKVNormChamber() { return m_Header.dCTNormChamber; }
  double GetSID() { return m_Header.dSAD * 10; }
  double GetIDUPosLng() { return m_Header.dIDUPosLng; }
  double GetIDUPosLat() { return m_Header.dIDUPosLat; }
  double GetIDUPosVrt() { return m_Header.dIDUPosVrt * 10; }

private:

	Att_header m_Header;

}; // end class AttImageIO

} // end namespace

#endif /* end #define __rtkAttImageIO_h  */
