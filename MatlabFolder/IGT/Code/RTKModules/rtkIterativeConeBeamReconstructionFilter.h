...
#include "igtWarpBackProjectionImageFilter.h"
...
public:
  ...
  typedef igt::WarpBackProjectionImageFilter < ProjectionStackType, VolumeType > WarpBackProjectionType;
  typedef typename BackProjectionFilterType::DVFPixelType					   	 DVFPixelType;
  typedef typename BackProjectionFilterType::DVFImageType 						 DVFImageType;
  typedef typename BackProjectionFilterType::DeformationType					 DeformationType;
  typedef typename DeformationType::Pointer 									 DeformationPointer;

#ifdef IGT_USE_CUDA
  typedef rtk::CudaWarpBackProjectionImageFilter							  CudaWarpBackProjectionType;
  typedef typename BackProjectionFilterType::CudaDVFPixelType				  CudaDVFPixelType;
  typedef typename BackProjectionFilterType::CudaDVFImageType				  CudaDVFImageType;
  typedef typename BackProjectionFilterType::CudaDeformationType		      CudaDeformationType;
...
#ifdef IGT_USE_CUDA
  itkSetMacro(CudaDeformation, CudaDeformationPointer);
  itkGetMacro(CudaDeformation, CudaDeformationPointer);
#endif
...
#ifdef IGT_USE_CUDA
  CudaDeformationPointer m_CudaDeformation;
#endif
