...
#ifndef __rtkCudaTotalVariationHessianOperatorImageFilter_h
#define __rtkCudaTotalVariationHessianOperatorImageFilter_h
...
/** \class CudaTotalVariationHessianOperatorImageFilter
 * \brief Implements the TotalVariationHessianOperatorImageFilter on GPU (only for 3D image now)
 *
 *
 *
 * \author Andy Shieh
 ...
 */
  ...
  class ITK_EXPORT CudaTotalVariationHessianOperatorImageFilter :
        public itk::CudaImageToImageFilter< itk::CudaImage<float,3>, itk::CudaImage<float,3>,
    TotalVariationHessianOperatorImageFilter< itk::CudaImage<float,3>, itk::CudaImage<float,3> > >
{
public:
  /** Standard class typedefs. */
  typedef rtk::CudaTotalVariationHessianOperatorImageFilter                             Self;
  typedef itk::CudaImage<float,3>                                                       OutputImageType;
  typedef rtk::TotalVariationHessianOperatorImageFilter< OutputImageType >			 	Superclass;
  ...
  itkTypeMacro(CudaTotalVariationHessianOperatorImageFilter, InterpolatorWithKnownWeightsImageFilter)
...
protected:
  igtcuda_EXPORT CudaTotalVariationHessianOperatorImageFilter();
...
private:
  CudaTotalVariationHessianOperatorImageFilter(const Self&); //purposely not implemented
