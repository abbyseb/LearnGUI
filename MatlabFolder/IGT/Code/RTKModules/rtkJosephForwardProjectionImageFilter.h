...
public:
  ...
  inline TOutput operator()( const typename itk::ThreadIdType itkNotUsed(threadId),
...
protected:
  ...
  inline OutputPixelType BilinearInterpolation(const typename itk::ThreadIdType threadId,
  ...
  inline OutputPixelType BilinearInterpolationOnBorders(const typename itk::ThreadIdType threadId,
                                               const double stepLengthInVoxel,
                                               const InputPixelType *pxiyi,
                                               const InputPixelType *pxsyi,
                                               const InputPixelType *pxiys,
