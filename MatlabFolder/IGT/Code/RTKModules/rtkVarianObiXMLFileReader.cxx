...
#define ENCAPLULATE_META_DATA_STRING(metaName) \
  ...
  ENCAPLULATE_META_DATA_DOUBLE("kVOffsetX1");
  ENCAPLULATE_META_DATA_DOUBLE("kVOffsetX2");
  ENCAPLULATE_META_DATA_DOUBLE("kVOffsetX3");
  ENCAPLULATE_META_DATA_DOUBLE("kVOffsetY1");
  ENCAPLULATE_META_DATA_DOUBLE("kVOffsetY2");
  ENCAPLULATE_META_DATA_DOUBLE("kVOffsetY3");
}
