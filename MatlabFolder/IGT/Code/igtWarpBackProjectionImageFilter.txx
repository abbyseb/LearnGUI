...
#ifndef __igtWarpBackProjectionImageFilter_txx
#define __igtWarpBackProjectionImageFilter_txx
...
void
WarpBackProjectionImageFilter<TInputImage,TOutputImage>
...
void
WarpBackProjectionImageFilter<TInputImage,TOutputImage>
::ThreadedGenerateData(const OutputImageRegionType& outputRegionForThread, typename itk::ThreadIdType threadId)
{
  ...
  typedef itk::LinearInterpolateImageFunction< typename DeformationType::OutputImageType, double > WarpInterpolatorType;
  ...
  itk::Matrix<double, Dimension+1, Dimension+1> matrixVol =
    rtk::GetPhysicalPointToIndexMatrix< TOutputImage >( this->GetOutput() );
