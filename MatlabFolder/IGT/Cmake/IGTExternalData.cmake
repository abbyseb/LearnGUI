get_filename_component(_IGTExternalData_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)
include(${_IGTExternalData_DIR}/ExternalData.cmake)
...
#
function(igt_add_test)
  # Add tests with data in the ITKData group.
  ExternalData_add_test(igtData ${ARGN})
endfunction()
