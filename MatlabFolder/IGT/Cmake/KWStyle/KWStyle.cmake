option(IGT_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
mark_as_advanced(IGT_USE_KWSTYLE)
if(IGT_USE_KWSTYLE)
...
set(KWSTYLE_CONFIGURATION_FILE
  ${PROJECT_BINARY_DIR}/cmake/KWStyle/IGT.kws.xml)

set(KWSTYLE_IGT_FILES_LIST
  ${PROJECT_BINARY_DIR}/cmake/KWStyle/IGTFiles.txt)

set(KWSTYLE_IGT_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/IGTOverwrite.txt )

#
# Configure the files
#
configure_file(
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/IGTFiles.txt.in
  ${KWSTYLE_IGT_FILES_LIST})

configure_file(
  ${PROJECT_SOURCE_DIR}/cmake/KWStyle/IGT.kws.xml.in
...
set(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_IGT_FILES_LIST}
  -o ${KWSTYLE_IGT_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

add_custom_command(
  OUTPUT  ${IGT_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

add_custom_target(StyleCheckCode DEPENDS ${IGT_BINARY_DIR}/KWStyleCodeReport.txt)

add_test(NAME KWStyleCodeTest
  COMMAND ${KWSTYLE_EXECUTABLE}
  ${KWSTYLE_ARGUMENTS_CODE}
  WORKING_DIRECTORY ${IGT_SOURCE_DIR})

endif(KWSTYLE_FOUND)
endif(KWSTYLE_EXECUTABLE)
endif(IGT_USE_KWSTYLE)
